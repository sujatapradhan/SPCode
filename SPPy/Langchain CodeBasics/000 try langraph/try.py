...
# Youtube: https://www.youtube.com/watch?v=v9fkbTxPzs0&t=2s
# Code: https://mer.vin/2024/01/langgraph-agents/
...
import functools, operator, requests, os, json, langgraph
...
spQ="""Search for the top 4 metro cities of India 
                              to provide population for each city"""
...
# Run the graph
for s in graph.stream({
    "messages": [HumanMessage(content=spQ)]
}):
    if "__end__" not in s:
        print(s)
        print("----")
# got rate imit errors 
